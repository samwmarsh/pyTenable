...
class ScanPolicyAPI(SCEndpoint):
    ...
    def template_list(self, fields=None):
        ...
        return self._api.get('v3/policyTemplate', params=params).json()['response']
    ...
    def template_details(self, id, fields=None, remove_editor=True):
        ...
        resp = self._api.get('v3/policyTemplate/{}'.format(self._check('id', id, int)),
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/policy', params=params).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/policy/{}'.format(self._check('id', id, int)),
            params=params).json()['response']
    ...
    def create(self, **kw):
        ...
        return self._api.post('v3/policy', json=policy).json()['response']
    ...
    def edit(self, id, **kw):
        ...
        return self._api.patch('v3/policy/{}'.format(
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/policy/{}'.format(
    ...
    def copy(self, id, name=None):
        ...
        return self._api.post('v3/policy/{}/copy'.format(
    ...
    def export_policy(self, id, fobj=None):
        ...
        '''
        resp = self._api.post('v3/policy/{}/export'.format(
    ...
    def import_policy(self, name, fobj, description=None, tags=None):
        ...
        return self._api.post('v3/policy/import', json=payload).json()['response']
    ...
    def share(self, id, *groups):
        ...
        '''
        return self._api.post('v3/policy/{}/share'.format(
    ...
    def tags(self):
        ...
        Examples:
            ...
            >>> pprint(tags)
        '''
        return self._api.get('v3/policy/tag').json()['response']
