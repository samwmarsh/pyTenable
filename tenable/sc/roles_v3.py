...
class RoleAPI(SCEndpoint):
    ...
    def create(self, name, **kw):
        ...
        return self._api.post('v3/role', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/role/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        '''
        payload = self._constructor(**kw)
        return self._api.patch('v3/role/{}'.format(
    ...
    def delete(self, id):
        ...
        Examples:
            >>> sc.roles.delete(1)
        '''
        return self._api.delete('v3/role/{}'.format(
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/role', params=params).json()['response']
