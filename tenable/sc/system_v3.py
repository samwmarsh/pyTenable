...
class SystemAPI(SCEndpoint):
    def details(self):
        ...
        '''
        return self._api.get('v3/system').json()['response']
    ...
    def diagnostics(self, task=None, options=None, fobj=None):
        ...
        self._api.post('v3/system/diagnostics/generate', json=payload)
        ...
        resp = self._api.post('v3/system/diagnostics/download', stream=True)
    ...
    def current_locale(self):
        ...
        '''
        return self._api.get('v3/system/locale').json()['response']
    ...
    def list_locales(self):
        ...
        '''
        return self._api.get('v3/system/locales').json()['response']
    ...
    def set_locale(self, locale):
        ...
        '''
        self._api.patch('v3/system/locale', json={
    ...
    def status(self):
        ...
        '''
        return self._api.get('v3/system/diagnostics').json()['response']
