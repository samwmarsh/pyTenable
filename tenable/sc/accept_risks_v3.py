...
class AcceptRiskAPI(SCEndpoint):
    ...
    def list(self, repo_ids=None, plugin_id=None, port=None,
        ...
        return self._api.get('v3/acceptRiskRule/v2', params=params).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/acceptRiskRule/{}'.format(self._check('id', id, int)),
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/acceptRiskRule/{}'.format(
    ...
    def apply(self, id, repo):
        ...
        '''
        return self._api.post('v3/acceptRiskRule/{}/apply'.format(
    ...
    def create(self, plugin_id, repos, **kw):
        ...
        return self._api.post('v3/acceptRiskRule', json=payload).json()['response'][0]