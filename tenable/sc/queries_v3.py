...
class QueryAPI(SCEndpoint):
    ...
    def create(self, name, tool, data_type, *filters, **kw):
        ...
        return self._api.post('v3/query', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/query/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, *filters, **kw):
        ...
        '''
        payload = self._constructor(*filters, **kw)
        return self._api.patch('v3/query/{}'.format(
    ...
    def delete(self, id):
        ...
        Examples:
            >>> sc.queries.delete(1)
        '''
        return self._api.delete('v3/query/{}'.format(
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/query', params=params).json()['response']
    ...
    def share(self, id, *groups):
        ...
        '''
        return self._api.post('v3/query/{}/share'.format(
    ...
    def tags(self):
        ...
        '''
        return self._api.get('v3/query/tag').json()['response']