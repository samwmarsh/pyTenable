...
class ScanResultAPI(SCEndpoint):
    def copy(self, id, *users):
        ...
        return self._api.post('v3/scanResult/{}/copy'.format(
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/scanResult/{}'.format(
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/scanResult/{}'.format(self._check('id', id, int)),
    ...
    def email(self, id, *emails):
        ...
        '''
        return self._api.post('v3/scanResult/{}/email'.format(
    ...
    def export_scan(self, id, fobj=None, export_format=None):
        ...
        '''
        resp = self._api.post('v3/scanResult/{}/download'.format(
    ...
    def reimport_scan(self, id, **kw):
        ...
        '''
        payload = self._api.scans._constructor(**kw)
        return self._api.post('v3/scanResult/{}/import'.format(self._check(
    ...
    def list(self, fields=None, start_time=None, end_time=None, optimize=True):
        ...
        return self._api.get('v3/scanResult', params=params).json()['response']
    ...
    def pause(self, id):
        ...
        '''
        return self._api.post('v3/scanResult/{}/pause'.format(self._check(
    ...
    def resume(self, id):
        ...
        '''
        return self._api.post('v3/scanResult/{}/resume'.format(self._check(
            'id', id, int))).json()['response']
    ...
    def stop(self, id):
        ...
        '''
        return self._api.post('v3/scanResult/{}/stop'.format(self._check(
            'id', id, int))).json()['response']
