...
class FeedAPI(SCEndpoint):
    def status(self, feed_type=None):
        ...
        if not feed_type:
            return self._api.get('v3/feed').json()['response']
        else:
            return self._api.get('v3/feed/{}'.format(feed_type)).json()['response']
    ...
    def update(self, feed_type=None):
        ...
        '''
        self._api.post('v3/feed/{}/update'.format(
    ...
    def process(self, feed_type, fobj):
        ...
        self._api.post('v3/feed/{}/process'.format(
            self._check('feed_type', feed_type, str, choices=[
