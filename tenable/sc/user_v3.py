...
class UserAPI(SCEndpoint):
    ...
    def create(self, username, password, role, **kw):
        ...
        return self._api.post('v3/user', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/user/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        '''
        payload = self._constructor(**kw)
        return self._api.patch('v3/user/{}'.format(
    ...
    def delete(self, id):
        ...
        Examples:
            >>> sc.users.delete(1)
        '''
        return self._api.delete('v3/user/{}'.format(
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/user', params=params).json()['response']
