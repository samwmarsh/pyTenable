...
class ScannerAPI(SCEndpoint):
    ...
    def create(self, name, address, **kw):
        ...
        return self._api.post('v3/scanner', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/scanner/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        return self._api.patch('v3/scanner/{}'.format(id),
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/scanner/{}'.format(
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/scanner', params=params).json()['response']
    ...
    def agent_scans(self, id, search, results=None):
        ...
        return self._api.post('v3/scanner/{}/testScansQuery'.format(
    ...
    def update_status(self):
        ...
        '''
        return self._api.post('v3/scanner/updateStatus',
