...
class RecastRiskAPI(SCEndpoint):
    ...
    def list(self, repo_ids=None, plugin_id=None, port=None,
        ...
        return self._api.get('v3/recastRiskRule', params=params).json()['response']
    ...
    def details(self, risk_id, fields=None):
        ...
        return self._api.get('v3/recastRiskRule/{}'.format(self._check('risk_id', risk_id, int)),
    ...
    def delete(self, risk_id):
        ...
        '''
        return self._api.delete('v3/recastRiskRule/{}'.format(
    ...
    def apply(self, risk_id, repo):
        ...
        '''
        return self._api.post('v3/recastRiskRule/{}/apply'.format(
    ...
    def create(self, plugin_id, repos, severity_id, **kwargs):
        ...
        return self._api.post('v3/recastRiskRule',
