...
class AssetListAPI(SCEndpoint):
    ...
    def create(self, name, list_type, **kw):
        ...
        return self._api.post('v3/asset', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/asset/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        '''
        payload = self._constructor(**kw)
        return self._api.patch('v3/asset/{}'.format(
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/asset/{}'.format(
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/asset', params=params).json()['response']
    ...
    def import_definition(self, fobj, name=None):
        ...
        return self._api.post('v3/asset/import', json=payload).json()['response']
    ...
    def export_definition(self, id, fobj=None):
        ...
        '''
        resp = self._api.get('v3/asset/{}/export'.format(
    ...
    def refresh(self, id, org_id, *repos):
        ...
        '''
        return self._api.post('v3/asset/{}/refresh'.format(
    ...
    def ldap_query(self, ldap_id, dn, search_string):
        ...
        '''
        return self._api.post('v3/asset/testLDAPQuery', json={
            'definedLDAPQuery': {
    ...
    def tags(self):
        ...
        '''
        return self._api.get('v3/asset/tag').json()['response']
    ...
    def share(self, id, *groups):
        ...
        '''
        return self._api.post('v3/asset/{}/share'.format(
            self._check('id', id, int)), json={
