...
class PluginAPI(SCEndpoint):
    ...
    def list(self, **kwargs):
        ...
        if json_result:
            return self._api.get('v3/plugin', params=query).json()['response']
    ...
    def details(self, plugin_id, fields=None):
       ...
       '''
        ...
        return self._api.get('v3/plugin/{}'.format(self._check('plugin_id', plugin_id, int)),
    ...
    def family_list(self, **kwargs):
        ...
        '''
        query = self._constructor(**kwargs)
        return self._api.get('v3/pluginFamily', params=query).json()['response']
    ...
    def family_details(self, plugin_id, fields=None):
        ...
        return self._api.get('v3/pluginFamily/{}'.format(self._check('plugin_id', plugin_id, int)), params=params).json()['response']
