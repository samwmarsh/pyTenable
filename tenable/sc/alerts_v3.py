...
class AlertAPI(SCEndpoint):
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/alert', params=params).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/alert/{}'.format(self._check('id', id, int)),
    ...
    def create(self, *filters, **kw):
        ...
        return self._api.post('v3/alert', json=payload).json()['response']
    ...
    def edit(self, id, *filters, **kw):
        ...
        '''
        payload = self._constructor(*filters, **kw)
        return self._api.patch('v3/alert/{}'.format(
    ...
    def delete(self, id):
        ...
        Examples:
            >>> sc.alerts.delete(1)
        '''
        return self._api.delete('v3/alert/{}'.format(
    ...
    def execute(self, id):
        ...
        Returns:
            :obj:`dict`:
                The alert resource.
        '''
        return self._api.post('v3/alert/{}/execute'.format(
            self._check('id', id, int))).json()['response']
