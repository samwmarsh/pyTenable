...
class OrganizationAPI(SCEndpoint):
    ...
    def create(self, name, **kwargs):
        ...
        return self._api.post('v3/organization', json=kwargs).json()['response']
    ...
    def list(self, fields=None):
        ...
        if fields:
            params['fields'] = ','.join([self._check('field', f, str)
                                         for f in fields])
        return self._api.get('v3/organization', params=params).json()['response']
    ...
    def details(self, organization_id, fields=None):
        ...
        return self._api.get('v3/organization/{}'.format(
    ...
    def edit(self, organization_id, **kwargs):
        ...
        '''
        kwargs = self._constructor(**kwargs)
        return self._api.patch('v3/organization/{}'.format(
    ...
    def delete(self, organization_id):
        ...
        '''
        return self._api.delete('v3/organization/{}'.format(
    ...
    def accept_risk_rules(self, organization_id, repos=None, plugin=None, port=None):
        ...
        return self._api.get('v3/organization/{}/acceptRiskRule'.format(
            self._check('organization_id', organization_id, int)), params=params).json()['response']
