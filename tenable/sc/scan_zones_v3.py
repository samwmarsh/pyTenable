...
class ScanZoneAPI(SCEndpoint):
    ...
    def create(self, name, **kw):
        ...
        return self._api.post('v3/zone', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/zone/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        '''
        payload = self._constructor(**kw)
        return self._api.patch('v3/zone/{}'.format(self._check('id', id, int)),
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/zone', params=params).json()['response']
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/zone/{}'.format(
