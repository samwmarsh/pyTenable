...
class CredentialAPI(SCEndpoint):
    ...
    def create(self, name, cred_type, auth_type, **kw):
        ...
        # Making the call.
        return self._api.post('v3/credential', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/credential/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        payload = self._constructor(**kw)
        return self._api.patch('v3/credential/{}'.format(
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/credential/{}'.format(
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/credential', params=params).json()['response']
    ...
    def tags(self):
        ...
        '''
        return self._api.get('v3/credential/tag').json()['response']
    ...
    def share(self, id, *groups):
        ...
        '''
        return self._api.post('v3/credential/{}/share'.format(
