...
class ScanAPI(SCEndpoint):
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/scan', params=params).json()['response']
    ...
    def create(self, name, repo, **kw):
        ...
        return self._api.post('v3/scan', json=scan).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/scan/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        '''
        scan = self._constructor(**kw)
        return self._api.patch('v3/scan/{}'.format(self._check('id', id, int)),
    ...
    def delete(self, id):
        ...
        Examples:
            >>> sc.scans.delete(1)
        '''
        return self._api.delete('v3/scan/{}'.format(self._check('id', id, int))
            ).json()['response']
    ...
    def copy(self, id, name, user_id):
        ...
        return self._api.post('v3/scan/{}/copy'.format(
    ...
    def launch(self, id, diagnostic_target=None, diagnostic_password=None):
        ...
        return self._api.post('v3/scan/{}/launch'.format(
