...
class GroupAPI(SCEndpoint):
    ...
    def create(self, name, **kw):
        ...
        return self._api.post('v3/group', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/group/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, **kw):
        ...
        '''
        payload = self._constructor(**kw)
        return self._api.patch('v3/group/{}'.format(
