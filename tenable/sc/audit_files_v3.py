...
class AuditFileAPI(SCEndpoint):
    ...
    def create(self, name, audit_file=None, tailoring_file=None, **kw):
        ...
        return self._api.post('v3/auditFile', json=payload).json()['response']
    ...
    def details(self, id, fields=None):
        ...
        return self._api.get('v3/auditFile/{}'.format(self._check('id', id, int)),
    ...
    def edit(self, id, audit_file=None, tailoring_file=None, **kw):
        ...
        payload = self._constructor(**kw)
        return self._api.patch('v3/auditFile/{}'.format(
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/auditFile/{}'.format(
    ...
    def list(self, fields=None):
        ...
        return self._api.get('v3/auditFile', params=params).json()['response']
    ...
    def export_audit(self, id, fobj=None):
        ...
        '''
        resp = self._api.get('v3/auditFile/{}/export'.format(
    ...
    def template_categories(self):
        ...
        Examples:
            ...
            ...     pprint(cat)
        '''
        return self._api.get('v3/auditFileTemplate/categories').json()['response']
    ...
    def template_details(self, id, fields=None):
        ...
        return self._api.get('v3/auditFileTemplate/{}'.format(
    ...
    def template_list(self, category=None, search=None, fields=None):
        ...
        return self._api.get('v3/auditFileTemplate',
            params=params).json()['response']
