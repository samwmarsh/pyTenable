...
class ScannerGroupsAPI(TIOEndpoint):
    ...
    def add_scanner(self, group_id, scanner_id):
        ...
        '''
        self._api.post('v3/scanner-groups/{}/scanners/{}'.format(
    ...
    def create(self, name, group_type=None):
        ...
        '''
        return self._api.post('v3/scanner-groups', json={
    ...
    def delete(self, group_id):
        ...
        '''
        self._api.delete('v3/scanner-groups/{}'.format(self._check('group_id', group_id, int)))
    ...
    def delete_scanner(self, group_id, scanner_id):
        ...
        '''
        self._api.delete('v3/scanner-groups/{}/scanners/{}'.format(
            self._check('group_id', group_id, int),
            self._check('scanner_id', scanner_id, int)
        ))
    ...
    def details(self, group_id):
        ...
        Examples:
            ...
            >>> pprint(group)
        '''
        return self._api.get('v3/scanner-groups/{}'.format(
    ...
    def edit(self, group_id, name):
        ...
        '''
        self._api.put('v3/scanner-groups/{}'.format(
            self._check('group_id', group_id, int)), json={
                'name': self._check('name', name, str)
        })
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(group)
        '''
        return self._api.get('v3/scanner-groups').json()['scanner_pools']
    ...
    def list_scanners(self, group_id):
        ...
        Examples:
            ...
            ...     pprint(scanner)
        '''
        return self._api.get('v3/scanner-groups/{}/scanners'.format(
    ...
    def list_routes(self, group_id):
        ...
        Returns:
         ...
         Examples:
            ...
            ...     pprint(scanner)
        '''
        return self._api.get('v3/scanner-groups/{}/routes'.format(
            self._check('group_id', group_id, int))).json()
    ...
    def edit_routes(self, group_id, routes):
        ...
        self._api.put('v3/scanner-groups/{}/routes'.format(
