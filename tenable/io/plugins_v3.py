...
class PluginsAPI(TIOEndpoint):
    ...
    def families(self):
        ...
        Examples:
            ...
            ...     pprint(family)
        '''
        return self._api.get('v3/plugins/families').json()['families']
    ...
    def family_details(self, family_id):
        ...
        '''
        return self._api.get('v3/plugins/families/{}'.format(
    ...
    def plugin_details(self, plugin_id):
        ...
        Examples:
            ...
            >>> pprint(plugin)
        '''
        return self._api.get('v3/plugins/plugin/{}'.format(
