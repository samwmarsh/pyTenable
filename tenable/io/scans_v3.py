...
class ScansAPI(TIOEndpoint):
        ...
        if 'policy' in kwargs:
            ...
            for item in policies:
                if kwargs['policy'] in [item['name'], item['id']] and not match:
                    policy_tmpl = self._api.editor.details('v3/scan/policy', item['id'])
    ...
    def attachment(self, scan_id, attachment_id, key, fobj=None):
        ...
        resp = self._api.get('v3/scans/{}/attachments/{}'.format(
            scan_id,
            attachment_id
    ...
    def configure(self, scan_id, **kw):
        ...
        return self._api.put('v3/scans/{}'.format(scan_id),
                    json=scan).json()
    ...
    def copy(self, scan_id, folder_id=None, name=None):
        ...
        return self._api.post('v3/scans/{}/copy'.format(scan_id),
            json=payload).json()
    ...
    def create(self, **kw):
        ...
        return self._api.post('v3/scans', json=scan).json()['scan']
    ...
    def delete(self, scan_id):
        ...
        Examples:
            >>> tio.scans.delete(1)
        '''
        self._api.delete('v3/scans/{}'.format(scan_id))
    ...
    def history(self, scan_id, limit=None, offset=None, pages=None, sort=None):
        ...
        return ScanHistoryIterator(self._api,
            ...
            _pages_total=pages,
            _query=query,
            _path='v3/scans/{}/history'.format(scan_id),
            _resource='history'
        )
    ...
    def delete_history(self, scan_id, history_id):
        ...
        '''
        self._api.delete('v3/scans/{}/history/{}'.format(
            scan_id,
            history_id))
    ...
    def details(self, scan_id):
        ...
        Examples:
            ...
            >>> pprint(scan)
        '''
        return self._api.editor.details('v3/scan', scan_id)
    ...
    def results(self, scan_id, history_id=None, history_uuid=None):
        ...
        return self._api.get('v3/scans/{}'.format(
    ...
    def export(self, scan_id, *filters, stream_hook=None, **kw):
        ...
        # File id for the job.
        fid = self._api.post('v3/scans/{}/export'.format(scan_id),
    ...
    def host_details(self, scan_id, host_id, history_id=None, history_uuid=None):
        ...
        return self._api.get('v3/scans/{}/hosts/{}'.format(
                scan_id,
    ...
    def import_scan(self, fobj, folder_id=None, password=None, aggregate=None):
        ...
        # the caller.
        return self._api.post('v3/scans/import', json=payload, params={
    ...
    def launch(self, scan_id, targets=None):
        ...
        return self._api.post('v3/scans/{}/launch'.format(
                scan_id),
    ...
    def list(self, folder_id=None, last_modified=None):
        ...
        return self._api.get('v3/scans', params=params).json()['scans']
    ...
    def pause(self, scan_id, block=False):
        ...
        Examples:
            >>> tio.scans.pause(1)
        '''
        self._api.post('v3/scans/{}/pause'.format(scan_id), json={})
        if block:
    ...
    def plugin_output(self, scan_id, host_id, plugin_id, history_id=None, history_uuid=None):
        ...
        return self._api.get('v3/scans/{}/hosts/{}/plugins/{}'.format(
            scan_id,
            self._check('host_id', host_id, int),
    ...
    def set_read_status(self, scan_id, read_status):
        ...
        '''
        self._api.put('v3/scans/{}/status'.format(scan_id), json={
    ...
    def resume(self, scan_id):
        ...
        Examples:
            >>> tio.scans.resume(1)
        '''
        self._api.post('v3/scans/{}/resume'.format(scan_id))
    ...
    def schedule(self, scan_id, enabled):
        ...
        '''
        return self._api.put('v3/scans/{}/schedule'.format(scan_id), json={
    ...
    def stop(self, scan_id, block=False):
        ...
        '''
        self._api.post('v3/scans/{}/stop'.format(scan_id))
        if block:
            self._block_while_running(scan_id)
    ...
    def status(self, scan_id):
        ...
        Examples:
            ...
            u'completed'
        '''
        return self._api.get('v3/scans/{}/latest-status'.format(scan_id)).json()['status']
    ...
    def timezones(self):
        ...
        Examples:
            ...
            ...     pprint(item)
        '''
        resp = self._api.get('v3/scans/timezones').json()['timezones']
    ...
    def info(self, scan_id, history_uuid):
        ...
        '''
        return self._api.get('v3/scans/{}/history/{}'.format(
            scan_id,
    ...
    def check_auto_targets(self, limit, matched_resource_limit,
        ...
        return self._api.post('v3/scans/check-auto-targets', params=query, json=payload).json()
