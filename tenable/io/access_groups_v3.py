...
:devportal:`access-groups-v3 <v3-access-groups>` API endpoints.

Methods available on ``tio.access_groups_v3``:

.. rst-class:: hide-signature
.. autoclass:: AccessGroupsV3API
...
class AccessGroupsIteratorV3(TIOIterator):
    '''
    The access groups v3 iterator provides a scalable way to work through
...
class AccessGroupsV3API(TIOEndpoint):
    '''
    ...
    def list(self, *filters, **kw):
        ...
        :devportal:`access-groups-v3: list <v3-access-groups-listt>`
        ...
        Args:
            *filters (tuple, optional):
                ...
                the :py:meth:`tio.filters.access_groups_filters_v3()` endpoint to get more details.
        ...
        Examples:
            ...
            >>> for group in tio.access_groups_v3.list():
            ...     pprint(group)

            Retrieving all of the windows agents:

            >>> for group in tio.access_groups_v3.list(('name', 'eq', 'win')):
            ...     pprint(group)
        '''
        limit = 50
        offset = 0
        ...
        query = self._parse_filters(filters,
            self._api.filters.access_group_filters_v3(), rtype='colon')
        ...
        # Return the Iterator.
        return AccessGroupsIteratorV3(self._api,
            _limit=limit,
            _offset=offset,
            _pages_total=pages,
            _query=query,
            _path='v3/access-groups',
    ...
    def create(self, name, rules, principals=None, all_users=False, access_group_type=None):
        ...
        :devportal:`access-groups: create <v3-access-groups-create>`
        ...
        Examples:
            ...
            >>> tio.access_groups_v3.create('Example',
        ...
        payload = {
            ...
            'rules': self._parse_filters(rules,
                self._api.filters.access_group_asset_rules_filters_v3(),
        ...
        return self._api.post('v3/access-groups', json=payload).json()

    def delete(self, group_id):
        '''
        Deletes the specified access group.

        :devportal:`access-groups: delete <v3-access-groups-delete>`

        Args:
            group_id (str): The UUID of the access group to remove.
        '''
        self._api.delete('v3/access-groups/{}'.format(
    ...
    def edit(self, group_id, **kw):
        ...
        :devportal:`access-groups: edit <v3-access-groups-edit>`
        ...
        # call the API endpoint and return the response to the caller.
        return self._api.put('v3/access-groups/{}'.format(group_id), json=payload).json()

    def details(self, group_id):
        '''
        Retrieves the details of the specified access group.

        :devportal:`access-groups: details <v3-access-groups-details>`

        Args:
            group_id (str): The UUID of the access group.
        '''
        return self._api.get('v3/access-groups/{}'.format(
