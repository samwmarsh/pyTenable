...
class FoldersAPI(TIOEndpoint):
    def create(self, name):
        ...
        '''
        return self._api.post('v3/folders', json={
    ...
    def delete(self, id):
        ...
        '''
        self._api.delete('v3/folders/{}'.format(self._check('id', id, int)))
    ...
    def edit(self, id, name):
        ...
        '''
        self._api.put('v3/folders/{}'.format(self._check('id', id, int)), json={
            'name': self._check('name', name, str)
        })
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(folder)
        '''
        return self._api.get('v3/folders').json()['folders']