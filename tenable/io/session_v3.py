...
class SessionAPI(TIOEndpoint):
    def edit(self, name, email):
        ...
        '''
        return self._api.put('v3/session', json={
    ...
    def details(self):
        ...
        Examples:
            ...
            >>> pprint(user)
        '''
        return self._api.get('v3/session').json()
    ...
    def change_password(self, old_password, new_password):
        ...
        '''
        self._api.put('v3/session/chpasswd', json={
    ...
    def gen_api_keys(self):
        ...
        '''
        return self._api.put('v3/session/keys').json()
    ...
    def two_factor(self, email, sms, phone=None):
        ...
        self._api.put('v3/session/two-factor', json=payload)
    ...
    def enable_two_factor(self, phone):
        ...
        '''
        self._api.post('v3/session/two-factor/send-verification', json={
    ...
    def verify_two_factor(self, code):
        ...
        '''
        self._api.post('v3/session/two-factor/verify-code', json={
