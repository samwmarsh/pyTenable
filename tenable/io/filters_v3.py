...
class FiltersAPI(TIOEndpoint):
    ...
    def access_group_asset_rules_filters(self, normalize=True):
        ...
        return self._use_cache('access_group_asset_filters',
            'v3/access-groups/rules/filters',
    ...
    def access_group_filters(self, normalize=True):
        ...
        return self._use_cache('access_groups',
            'v3/access-groups/filters', normalize=normalize)

    def access_group_filters_v3(self, normalize=True):
        '''
        Returns access group filters v3.

        :devportal:`filters: access_group_filters_v3 <v3-access-groups-list-filters>`
        ...
        Examples:
            >>> filters = tio.filters.access_group_filters_v3()
        '''
        return self._use_cache('access_groups_v3',
            'v3/access-groups/filters', normalize=normalize)

    def access_group_asset_rules_filters_v3(self, normalize=True):
        '''
        Returns access group rules filters v3.

        :devportal:`filters: access_group_asset_rules_filters_v3
            <v3-access-groups-list-rule-filters>`
        ...
        Examples:
            >>> filters = tio.filters.access_group_rules_filters_v3()
        '''
        return self._use_cache('access_group_asset_filters_v3',
            'v3/access-groups/rules/filters',
            field_name='rules', normalize=normalize)
    ...
    def agents_filters(self, normalize=True):
        ...
        '''
        return self._use_cache('agents', 'v3/filters/scans/agents',
                               normalize=normalize)
    ...
    def workbench_vuln_filters(self, normalize=True):
        ...
        return self._use_cache('vulns',
            'v3/filters/workbenches/vulnerabilities', normalize=normalize)
    ...
    def workbench_asset_filters(self, normalize=True):
        ...
        '''
        return self._use_cache('asset', 'v3/filters/workbenches/assets',
                               normalize=normalize)
    ...
    def scan_filters(self, normalize=True):
        ...
        '''
        return self._use_cache('scan', 'v3/filters/scans/reports',
                               normalize=normalize)
    ...
    def credentials_filters(self, normalize=True):
        ...
        Examples:
            >>> filters = tio.filters.scan_filters()
        '''
        return self._use_cache('scan', 'v3/filters/credentials',
                               normalize=normalize)
    ...
    def asset_tag_filters(self):
        ...
        '''
        return self._use_cache('tags', 'v3/tags/assets/filters')
