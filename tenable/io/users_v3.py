...
class UsersAPI(TIOEndpoint):
    ...
    def create(self, username, password, permissions,
        ...
        return self._api.post('v3/users', json=payload).json()
    ...
    def delete(self, user_id):
        ...
        Examples:
            >>> tio.users.delete(1)
        '''
        self._api.delete('v3/users/{}'.format(self._check('user_id', user_id, int)))
    ...
    def details(self, user_id):
        ...
        '''
        return self._api.get('v3/users/{}'.format(self._check('user_id', user_id, int))).json()
    ...
    def edit(self, user_id, permissions=None, name=None, email=None, enabled=None):
        ...
        return self._api.put('v3/users/{}'.format(user_id), json=payload).json()
    ...
    def enabled(self, user_id, enabled):
        ...
        '''
        return self._api.put('v3/users/{}/enabled'.format(
    ...
    def two_factor(self, user_id, email, sms, phone=None):
        ...
        self._api.put('v3/users/{}/two-factor'.format(
    ...
    def enable_two_factor(self, user_id, phone):
        ...
        '''
        self._api.post('v3/users/{}/two-factor/send-verification'.format(
            self._check('user_id', user_id, int)), json={
    ...
    def verify_two_factor(self, user_id, code):
        ...
        '''
        self._api.post('v3/users/{}/two-factor/verify-code'.format(
            self._check('user_id', user_id, int)), json={
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(user)
        '''
        return self._api.get('v3/users').json()['users']
    ...
    def change_password(self, user_id, old_password, new_password):
        ...
        '''
        self._api.put('v3/users/{}/chpasswd'.format(self._check('user_id', user_id, int)), json={
    ...
    def gen_api_keys(self, user_id):
        ...
        '''
        return self._api.put('v3/users/{}/keys'.format(
            self._check('user_id', user_id, int))).json()
    ...
    def list_auths(self, user_id):
        ...
        '''
        return self._api.get('v3/users/{}/authorizations'.format(
            self._check('user_id', user_id, int))).json()
    ...
    def edit_auths(self, user_id, api_permitted=None, password_permitted=None, saml_permitted=None):
        ...
        return self._api.put('v3/users/{}/authorizations'.format(
            self._check('user_id', user_id, int)), json=payload)
