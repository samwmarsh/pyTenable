...
class CredentialsAPI(TIOEndpoint):
    ...
    def create(self, cred_name, cred_type, description=None,
        ...
        return self._api.post('v3/credentials', json={
    ...
    def edit(self, cred_uuid, cred_name=None, description=None,
        ...
        return self._api.put('v3/credentials/{}'.format(cred_uuid),
    ...
    def details(self, id):
        ...
        '''
        return self._api.get('v3/credentials/{}'.format(
    ...
    def delete(self, id):
        ...
        '''
        return self._api.delete('v3/credentials/{}'.format(
    ...
    def types(self):
        ...
        '''
        return self._api.get('v3/credentials/types').json()['credentials']
    ...
    def upload(self, fobj):
        ...
        return self._api.post('v3/credentials/files', **kw).json()['fileuploaded']
