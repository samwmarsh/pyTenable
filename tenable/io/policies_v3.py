...
class PoliciesAPI(TIOEndpoint):
    ...
    def configure(self, id, policy):
        ...
        '''
        self._api.put('v3/policies/{}'.format(self._check('id', id, int)),
    ...
    def copy(self, id):
        ...
        '''
        return self._api.post('v3/policies/{}/copy'.format(
    ...
    def create(self, policy):
        ...
        '''
        return self._api.post('v3/policies',
    ...
    def delete(self, id):
        ...
        '''
        self._api.delete('v3/policies/{}'.format(self._check('id', id, int)))
    ...
    def details(self, id):
        ...
        Examples:
            >>> policy = tio.policies.details(1)
        '''
        return self._api.get('v3/policies/{}'.format(
            self._check('id', id, int))).json()
    ...
    def policy_import(self, fobj):
        ...
        return self._api.post('v3/policies/import', json={'file': fid}).json()
    ...
    def policy_export(self, id, fobj=None):
        ...
        resp = self._api.get('v3/policies/{}/export'.format(
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(policy)
        '''
        return self._api.get('v3/policies').json()['policies']
