...
class GroupsAPI(TIOEndpoint):
    def add_user(self, group_id, user_id):
        ...
        '''
        self._api.post('v3/groups/{}/users/{}'.format(
    ...
    def create(self, name):
        ...
        '''
        return self._api.post('v3/groups', json={
    ...
    def delete(self, id):
        ...
        Examples:
            >>> tio.groups.delete(1)
        '''
        self._api.delete('v3/groups/{}'.format(self._check('id', id, int)))
    ...
    def delete_user(self, group_id, user_id):
        ...
        '''
        self._api.delete('v3/groups/{}/users/{}'.format(
            self._check('group_id', group_id, int),
    ...
    def edit(self, id, name):
        ...
        '''
        return self._api.put('v3/groups/{}'.format(self._check('id', id, int)),
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(group)
        '''
        return self._api.get('v3/groups').json()['groups']
    ...
    def list_users(self, id):
        ...
        Example:
            ...
            ...     pprint(user)
        '''
        return self._api.get('v3/groups/{}/users'.format(
