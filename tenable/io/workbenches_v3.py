...
class WorkbenchesAPI(TIOEndpoint):
    ...
    def assets(self, *filters, **kw):
        ...
        return self._api.get('v3/workbenches/assets', params=query).json()['assets']
    ...
    def asset_activity(self, uuid):
        ...
        Examples:
            ...
            ...     pprint(entry)
        '''
        return self._api.get('v3/workbenches/assets/{}/activity'.format(
    ...
    def asset_info(self, uuid, all_fields=True):
        ...
        return self._api.get('v3/workbenches/assets/{}/info'.format(
    ...
    def asset_vulns(self, uuid, *filters, **kw):
        ...
        return self._api.get(
            'v3/workbenches/assets/{}/vulnerabilities'.format(
    ...
    def asset_vuln_info(self, uuid, plugin_id, *filters, **kw):
        ...
        return self._api.get(
            'v3/workbenches/assets/{}/vulnerabilities/{}/info'.format(
    ...
    def asset_vuln_output(self, uuid, plugin_id, *filters, **kw):
        ...
        return self._api.get(
            'v3/workbenches/assets/{}/vulnerabilities/{}/outputs'.format(
                self._check('uuid', uuid, 'uuid'),
    ...
    def vuln_assets(self, *filters, **kw):
        ...
        return self._api.get(
            'v3/workbenches/assets/vulnerabilities', params=query).json()['assets']
    ...
    def export(self, *filters, **kw):
        ...
        # File id for the job.
        fid = self._api.get('v3/workbenches/export',
        ...
        self._wait_for_download(
            'v3/workbenches/export/{}/status'.format(fid),
            'workbenches', 'export', fid)

        # Now that the status has reported back as "ready", we can actually
        # download the file.
        resp = self._api.get('v3/workbenches/export/{}/download'.format(
            fid), stream=True)
    ...
    def vulns(self, *filters, **kw):
        ...
        return self._api.get(
            'v3/workbenches/vulnerabilities', params=query).json()['vulnerabilities']
    ...
    def vuln_info(self, plugin_id, *filters, **kw):
        ...
        return self._api.get(
            'v3/workbenches/vulnerabilities/{}/info'.format(
                self._check('plugin_id', plugin_id, int)), params=query).json()['info']
    ...
    def vuln_outputs(self, plugin_id, *filters, **kw):
        ...
        return self._api.get(
            'v3/workbenches/vulnerabilities/{}/outputs'.format(
                self._check('plugin_id', plugin_id, int)), params=query).json()['outputs']
