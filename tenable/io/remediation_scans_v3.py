...
class RemediationScansIteratorv3(TIOIterator):
    '''
...
class RemediationScansAPI(TIOEndpoint):
    ...
    def list_remediation_scan(self, limit=50, offset=0, sortval='scan_creation_date:desc'):
        ...
        Returns:
            :obj:`RemediationScansIteratorv3`:
        ...
        return RemediationScansIteratorv3(self._api,
        _limit=limit,
        _offset=offset,
        _pages_total=pages,
        _query=params,
        _path='v3/scans/remediation',
        _resource='scans')
    ...
    def create_remediation_scan(self, **kwargs):
        ...
        return  self._api.post('v3/scans/remediation', json=scan).json()['scan']
