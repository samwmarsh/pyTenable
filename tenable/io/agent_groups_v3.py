...
class AgentGroupsAPI(TIOEndpoint):
    def add_agent(self, group_id, *agent_ids, **kw):
        ...
        if len(agent_ids) <= 1:
            ...
            self._api.put('v3/scanners/{}/agent-groups/{}/agents/{}'.format(
            ...
            return self._api.post(
                'v3/scanners/{}/agent-groups/{}/agents/_bulk/add'.format(
                    self._check('scanner_id', scanner_id, int),
                    self._check('group_id', group_id, int)),
    ...
    def configure(self, group_id, name, scanner_id=1):
        ...
        '''
        self._api.put('v3/scanners/{}/agent-groups/{}'.format(
            self._check('scanner_id', scanner_id, int),
            self._check('group_id', group_id, int)
    ...
    def create(self, name, scanner_id=1):
        ...
        '''
        return self._api.post(
            'v3/scanners/{}/agent-groups'.format(
                self._check('scanner_id', scanner_id, int)
            ), json={'name': self._check('name', name, str)}).json()
    ...
    def delete(self, group_id, scanner_id=1):
        ...
        '''
        self._api.delete('v3/scanners/{}/agent-groups/{}'.format(
            self._check('scanner_id', scanner_id, int),
            self._check('group_id', group_id, int)
        ))
    ...
    def delete_agent(self, group_id, *agent_ids, **kw):
        ...
        if len(agent_ids) <= 1:
            ...
            self._api.delete('v3/scanners/{}/agent-groups/{}/agents/{}'.format(
                self._check('scanner_id', scanner_id, int),
                self._check('group_id', group_id, int),
                self._check('agent_id', agent_ids[0], int)
            ))
            ...
            return self._api.post(
                'v3/scanners/{}/agent-groups/{}/agents/_bulk/remove'.format(
                    self._check('scanner_id', scanner_id, int),
                    self._check('group_id', group_id, int)),
    ...
    def list(self, scanner_id=1):
        ...
        '''
        return self._api.get('v3/scanners/{}/agent-groups'.format(
    ...
    def task_status(self, group_id, task_uuid, scanner_id=1):
        ...
        '''
        return self._api.get(
            'v3/scanners/{}/agent-groups/{}/agents/_bulk/{}'.format(
                self._check('scanner_id', scanner_id, int),
                self._check('group_id', group_id, int),
