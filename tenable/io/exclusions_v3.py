...
class ExclusionsAPI(TIOEndpoint):
    ...
    def create(self, name, members, start_time=None, end_time=None,
        ...
        return self._api.post('v3/exclusions', json=payload).json()
    ...
    def delete(self, exclusion_id):
        ...
        '''
        self._api.delete('v3/exclusions/{}'.format(self._check('exclusion_id', exclusion_id, int)))
    ...
    def details(self, exclusion_id):
        ...
        return self._api.get(
            'v3/exclusions/{}'.format(self._check('exclusion_id', exclusion_id, int))).json()
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(exclusion)
        '''
        return self._api.get('v3/exclusions').json()['exclusions']
    ...
    def exclusions_import(self, fobj):
        ...
        return self._api.post('v3/exclusions/import', json={'file': fid})
