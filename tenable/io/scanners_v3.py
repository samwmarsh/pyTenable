...
class ScannersAPI(TIOEndpoint):
    ...
    def allowed_scanners(self):
        ...
        vm_tmpl = self._api.policies.templates().get('v3/advanced', None)
        was_tmpl = self._api.policies.templates().get('v3/was_scan', None)
        scanners = get_scanners(self._api.editor.template_details('v3/scan', vm_tmpl))
        if was_tmpl is not None:
            scanners.extend(get_scanners(self._api.editor.template_details('v3/scan', was_tmpl)))
        return scanners
    ...
    def control_scan(self, scanner_id, scan_uuid, action):
        ...
        '''
        self._api.post('v3/scanners/{}/scans/{}/control'.format(
    ...
    def delete(self, id):
        ...
        '''
        self._api.delete('v3/scanners/{}'.format(self._check('id', id, int)))
    ...
    def details(self, id):
        ...
        Examples:
            ...
            >>> pprint(scanner)
        '''
        return self._api.get('v3/scanners/{}'.format(
    ...
    def edit(self, id, **kwargs):
        ...
        self._api.put('v3/settings/{}'.format(self._check('id', id, int)),
            json=payload)
    ...
    def get_aws_targets(self, id):
        ...
        Examples:
            ...
            ...      pprint(target)
        '''
        return self._api.get('v3/scanners/{}/aws-targets'.format(
    ...
    def get_scanner_key(self, id):
        ...
        '''
        return str(self._api.get('v3/scanners/{}/key'.format(
    ...
    def get_scans(self, id):
        ...
        Examples:
            ...
            ...     pprint(scan)
        '''
        return self._api.get('v3/scanners/{}/scans'.format(
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(scanner)
        '''
        return self._api.get('v3/scanners').json()['scanners']
    ...
    def toggle_link_state(self, id, linked):
        ...
        '''
        self._api.put('v3/scanners/{}/link'.format(self._check('id', id, int)),
    ...
    def get_permissions(self, id):
        ...
        '''
        return self._api.permissions.list('v3/scanner', self._check('id', id, int))
    ...
    def edit_permissions(self, id, *acls):
        ...
        '''
        self._api.permissions.change('v3/scanner', self._check('id', id, int), *acls)
