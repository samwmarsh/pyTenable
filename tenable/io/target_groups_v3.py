...
class TargetGroupsAPI(TIOEndpoint):
    ...
    def delete(self, id):
        ...
        '''
        self._api.delete('v3/target-groups/{}'.format(self._check('id', id, int)))
    ...
    def details(self, id):
        ...
        '''
        return self._api.get('v3/target-groups/{}'.format(
    ...
    def edit(self, id, **kw):
        ...
        return self._api.put('v3/target-groups/{}'.format(id), json=payload).json()
    ...
    def list(self):
        ...
        Examples:
            ...
            ...     pprint(tg)
        '''
        return self._api.get('v3/target-groups').json()['target_groups']